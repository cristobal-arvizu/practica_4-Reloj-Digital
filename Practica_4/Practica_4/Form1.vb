Public Class Form1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ' Crear una variable, le asigna un valor, el valor es la fecha del dia de hoy convertido a string en el formato de "dd 'de' MMMM 'del' yyyy" [dd- numero de dia, MMMM- el mes en texto, yyyy- para el año]
